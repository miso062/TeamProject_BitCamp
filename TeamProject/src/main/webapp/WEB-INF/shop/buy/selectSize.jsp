								...
								<li data-v-02c63ee6="" class="select_item" id="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid" id="button">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_225">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_230">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_235">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_240">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_245">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_250">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_255">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_260">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_265">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_270">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_275">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_280">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_285">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_290">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_295">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_300">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_305">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid" id="button">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_310">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_315">
										</div>
									</button>
								</li>
								<li data-v-02c63ee6="" class="select_item">
									<button data-v-02c63ee6="" role="button" aria-selected="false" class="select_link buy bid">
										<div data-v-02c63ee6="" class="link_inner">
											...
											<input type="hidden" class="sell_dto" id="sell_dto_size_320">
										</div>
									</button>
								</li>
							</ul>
...
$(function(){
	...
	$('.select_item').click(function(){
		...
		$('#selected_id').val($(this).find('.sell_dto').val());
	});
	...
	$.ajax({
		...
		success: function(data){
			$.each(data, function(index, item){
				var price_id = "#price_size_" + item.size_type;
				var dto_id = '#sell_dto_size_' +  item.size_type;
				var price = item.sell_price.toString();
				price = price.replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
				if(price != ''){
					$(price_id).text(price);
					$(dto_id).val(item.sell_id);
					$(price_id).parent().parent().removeClass('bid');
				}
			});
		},
		error: function(err){
...
$('#goNextBtn').click(function(){
	if($('#selected_id').val() != ''){
		location.href="/TeamProject/shop/buyCheck?sell="+$('#selected_id').val();
	}
	else {
