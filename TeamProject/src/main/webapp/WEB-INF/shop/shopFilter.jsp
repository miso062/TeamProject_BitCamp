...
$(function(){
	...
	$('.checkbox-icon').click(function(){
		...
		if($(this).hasClass('checkbox-inactive')){
			...
			$(this).closest("div").prev().find('span:eq(1)').hide(); //서치에서 필요없는 부분
			/* 상품태그 추가 생성 */
