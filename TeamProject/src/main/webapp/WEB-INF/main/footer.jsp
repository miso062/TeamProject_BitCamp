...
.banner_bottom .info_title[data-v-d772dcbe] {
   padding-top: 12px;
   text-shadow: -1px 0 #565656, 0 1px #565656, 1px 0 #565656, 0 -1px
      #565656;
   font-size: 16px;
   letter-spacing: -.16px
}

.banner_bottom .info_txt[data-v-d772dcbe] {
   margin-top: 16px;
   padding: 0 7px;
...
.banner_bottom.mo[data-v-d772dcbe], .banner_bottom.sm[data-v-d772dcbe] {
   display: block
}

.banner_bottom.mo .banner_box[data-v-d772dcbe], .banner_bottom.sm .banner_box[data-v-d772dcbe]
   {
   padding: 29px 21px 0;
   display: block;
...
.banner_bottom.mo .info_title[data-v-d772dcbe], .banner_bottom.sm .info_title[data-v-d772dcbe]
   {
   padding-top: 37px
}
...
<div class="banner_bottom md" data-v-d772dcbe="" data-v-2278857d="">
   <a href="#" class="banner_box1" data-v-d772dcbe="">
    ...
    <a href="#" class="banner_box2" data-v-d772dcbe="">
...
<div id="service_info">
   <ul>
      ...
      <div id="service_type">
         <li ><a id="footer_a" href="">검수기준&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;공지사항</a></li><br>
         <li><a id="footer_a" href="">이용정책&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;서비스 소개</a></li><br>
         <li><a id="footer_a" href="">패널티 정책&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;쇼룸 안내</a></li><br>
         <li><a id="footer_a" href="">커뮤니티 가이드라인&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;판매자 방문접수</a></li>
   </ul>
</div>
...
<div class="footer_corporation">
   <ul >
      <li ><a id="footer_a" href="">회사소개&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
      <li><a id="footer_a" href="">인재채용&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
      <li><a id="footer_a" href="">제휴제안&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
      <li><a id="footer_a" href="">이용약관&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
      <li><a id="footer_a" href=""><b>개인정보처리방침</b></a></li><br><br>
