...
<body>
	...
	<div id="container">
		<div class="join_area">
		    ...
		    <div class="input_box has_error">
		        ...
		        <div class="input_item"><input type="text"  placeholder="예) gese_t@gese.co.kr" onchange="oninputEmail1(this.value)"  autocomplete="off" class="input_txt log_email_input" readonly /></div>
		    </div>
			<div class="input_box has_error has_button">
		        <h3 class="input_title ess log_name_label" >이름</h3>
		        <div class="input_item"><input type="text" placeholder="ex)홍길동 2-10자" onchange="inputName(this.value)"  autocomplete="off" class="input_txt log_name_input" readonly /></div>
	...
	<script type="text/javascript">
		...
		function signupCheck(){ 
			if((resultName == true) && (resultNick == true)  && (resultHp == true) && ($('#essential_check').hasClass('ico-check-active') )){
	...
	$(document).on('click', '.btn_join.abled', function(){
		...
		$.ajax({
			type: 'post',
			url : '/TeamProject/user/signUpKakao',
