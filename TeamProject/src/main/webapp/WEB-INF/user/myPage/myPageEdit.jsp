               ...
               <div class="unit input_box has_error has_button">
                  <div class="input_box has_error has_button">
                    <h5 class="title input_pwdcheck_title input_title ess log_pwdcheck_label" >비밀번호 재확인</h5>
                       <div class="input_item">
                          <input type="password" id="password_2" value="" placeholder="영문, 숫자, 특수문자 조합 8-16자" onchange="oninputPwdcheck()"  autocomplete="off" class="desc input_txt log_pwdcheck_input log_pwd_input" />
                       </div>
