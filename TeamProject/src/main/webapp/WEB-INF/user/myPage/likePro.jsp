...
.wish_item, .wish_item:active, .wish_item:focus, .wish_item:hover{
text-decoration: none;
}
...
.pagination_box.first .prev_btn_box[data-v-bffefc20], .pagination_box.last .next_btn_box[data-v-bffefc20]
	{
	display: none;
}
...
.next_btn_box[data-v-bffefc20], .prev_btn_box[data-v-bffefc20] {
	display: inline-block;
	vertical-align: top;
}

.next_btn_box .btn_arr[data-v-bffefc20], .prev_btn_box .btn_arr[data-v-bffefc20]
	{
	padding: 3px;
	width: 24px;
	height: 24px;
...
.next_btn_box .btn_arr+.btn_arr[data-v-bffefc20], .prev_btn_box .btn_arr+.btn_arr[data-v-bffefc20]
	{
	margin-left: 5px;
}
		...
		<div data-v-bffefc20="" class="pagination_box first last">
			<div data-v-bffefc20="" class="prev_btn_box">
				<a data-v-bffefc20="" href="/my/wish?page=1" class="btn_arr"
					aria-label="첫 페이지"> <svg data-v-bffefc20=""
						xmlns="http://www.w3.org/2000/svg"
						class="arr-page-first icon sprite-icons">
                        <use data-v-bffefc20=""
							href="/_nuxt/a7a7eb5a7757da9bd1f7f0de66705692.svg#i-arr-page-first"
							xlink:href="/_nuxt/a7a7eb5a7757da9bd1f7f0de66705692.svg#i-arr-page-first"></use>
                    </svg>
				</a> <a data-v-bffefc20="" href="/my/wish?page=0" class="btn_arr"
					aria-label="이전 페이지"> <svg data-v-bffefc20=""
						xmlns="http://www.w3.org/2000/svg"
						class="arr-page-prev icon sprite-icons">
                        <use data-v-bffefc20=""
							href="/_nuxt/a7a7eb5a7757da9bd1f7f0de66705692.svg#i-arr-page-prev"
							xlink:href="/_nuxt/a7a7eb5a7757da9bd1f7f0de66705692.svg#i-arr-page-prev"></use>
                    </svg>
				</a>
			</div>
			<div data-v-bffefc20="" class="page_bind">
				<a data-v-bffefc20="" href="/my/wish?page=1" class="btn_page active"
					aria-label="1페이지"> 1 </a>
			</div>
			<div data-v-bffefc20="" class="next_btn_box">
				<a data-v-bffefc20="" href="/my/wish?page=2" class="btn_arr"
					aria-label="다음 페이지"> <svg data-v-bffefc20=""
						xmlns="http://www.w3.org/2000/svg"
						class="arr-page-next icon sprite-icons">
                        <use data-v-bffefc20=""
							href="/_nuxt/a7a7eb5a7757da9bd1f7f0de66705692.svg#i-arr-page-next"
							xlink:href="/_nuxt/a7a7eb5a7757da9bd1f7f0de66705692.svg#i-arr-page-next"></use>
                    </svg>
				</a> <a data-v-bffefc20="" href="/my/wish?page=1" class="btn_arr"
					aria-label="마지막 페이지"> <svg data-v-bffefc20=""
						xmlns="http://www.w3.org/2000/svg"
						class="arr-page-last icon sprite-icons">
                        <use data-v-bffefc20=""
							href="/_nuxt/a7a7eb5a7757da9bd1f7f0de66705692.svg#i-arr-page-last"
							xlink:href="/_nuxt/a7a7eb5a7757da9bd1f7f0de66705692.svg#i-arr-page-last"></use>
                    </svg>
				</a>
			</div>
		</div>
	...
	$.ajax({
		...
		success:function(data){
			...
			$('<li/>',{
				...
				href:'/TeamProject/shop?sort=popular&command='+data.list2[i].brand
			}))).append($('<p/>',{
				class:'name',
				text: data.list2[i].eng_name
			})).append($('<p/>',{
				class:'name-ko',
				text: data.list2[i].kor_name
			})))).append($('<div/>',{
				class:'wish_buy'
			}).append($('<div/>',{
				...
				class:'btn_division buy',
				href:'/TeamProject/shop/selectBuySize?product_id='+data.list2[i].product_id
			}).append($('<div/>',{
				class:'title',
				text:'구매'
			})))).append($('<a/>',{
				...
				text:'삭제'
				   ...
				   type:'hidden',
				   class : 'likePro_product_id',
				   id: 'likePro_product_id'+data.list2[i].product_id,
...
//마이페이지 관심상품 목록 삭제버튼 클릭시 삭제하기
$(document).on('click', '.status_link', function(){
	$.ajax({
		type:'post',
		url:'/TeamProject/user/likeProDelete',
		data:{'product_id': $(this).parents(".wish_item").next().val()},
		success: function(){
			location.reload();
		},
		error : function(err){
